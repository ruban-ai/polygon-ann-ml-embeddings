...
ShapeToVec~\cite{shape2vec} at its \emph{highest-fidelity} resolution (tens of
thousands of dimensions): the finest quadtree best preserves shape detail and gives
