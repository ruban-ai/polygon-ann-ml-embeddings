...
training the encoder as a candidate \emph{filter} --- a non-saturating contrastive
objective over the broad neighbourhood --- which restores recall and yields a more
navigable index. This is, to our knowledge, the first learned WJ embedding to
