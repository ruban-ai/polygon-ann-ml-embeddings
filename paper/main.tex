...
ShapeToVec~\cite{shape2vec} encodes polygons with the adaptive quadtree
rasterisation motivated in Sec.~\ref{sec:intro-gap}, indexing the resulting
18{,}219-dimensional WJ simplex vectors directly with HNSW~\cite{hnsw20} to reach
$\geq$97\% R@50 on corpora up to 1.7M polygons. Our work compresses these vectors
$36\times$ while preserving their WJ structure.
