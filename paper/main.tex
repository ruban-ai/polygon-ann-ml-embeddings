...
Reranking $K$ candidates reorders but cannot enlarge the retrieved set, so R@500
at $K{=}500$ equals Stage-1 R@500 by construction; R@10/R@50 improve because the
true nearest neighbours, reliably within the pool, are promoted to their correct
positions. Raising $K$ to 1{,}000 lifts R@500 to 0.990 --- a coverage--speed
tradeoff, not a model deficiency.
