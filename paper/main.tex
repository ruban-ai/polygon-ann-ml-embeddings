...
(ii)~\textbf{Hashing}: ICWS~\cite{ioffe10} (512-hash WJ sketch, an unbiased WJ
estimator, brute-force$^\dagger$) and Deep Binary Hashing~\cite{deephashsurvey22}
(512-bit learned Hamming codes);
