...
\begin{table}[t]
\centering
\caption{Stage-1 and Stage-2 results on OSM Parks (10k subset; full corpus in
Table~\ref{tab:full}). $\dagger$~brute-force only. \textbf{Bold}~=~best ANN
method. $\ddagger$~=~ours.}
\label{tab:results}
...
the QPS of brute-force ICWS. After Stage-2 reranking ($K{=}500$), R@10 reaches
0.997 at 75--1{,}139\,QPS. Reranking reorders but cannot enlarge the pool, so
R@500 at $K{=}500$ equals Stage-1 R@500; raising $K$ to 1{,}000 lifts it to 0.990.
