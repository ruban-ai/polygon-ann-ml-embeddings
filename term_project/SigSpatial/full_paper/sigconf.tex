...
trained via a rank-aware \emph{listwise} loss so the compact embedding's WJ directly
reproduces the true WJ, beating absolute-value regression and five further rank-aware
and Matryoshka-training alternatives at every scale we test. Against ShapeToVec's own
