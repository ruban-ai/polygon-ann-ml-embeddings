...
\begin{enumerate}[leftmargin=1.2em,itemsep=1pt,topsep=1pt]
  \item \textbf{Compression that nearly matches, then beats, ShapeToVec's own
    ...
    identical Parks dataset, our $12$--$47\times$ smaller embeddings retain
    $92$--$93\%$ of their recall without any reranking, at $4$--$14\times$ the
    throughput, and exceed their best published recall entirely after a cheap
    exact-WJ rerank pass, while remaining several-fold faster than their most
    accurate configuration (\S\ref{sec:exp}).
