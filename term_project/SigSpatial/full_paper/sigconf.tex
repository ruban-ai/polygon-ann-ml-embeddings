...
throughput. ShapeToVec+ compresses these into compact bit-signatures, up to
$32\times$ smaller, but at real accuracy cost at its most aggressive settings (recall
falling from $96\%$ to $76\%$ on the identical dataset). Both rely on
