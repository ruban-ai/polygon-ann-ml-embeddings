...
several-fold faster than their most accurate configuration. The same architecture and
training recipe, unchanged, generalise to a second, structurally different polygon
class, water bodies.
\end{abstract}
