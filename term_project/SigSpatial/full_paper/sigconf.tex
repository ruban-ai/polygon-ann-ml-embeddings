...
(e.g.\ a neighbourhood park versus a national forest), so a
uniform grid either explodes in dimension or collapses small shapes into
near-empty vectors: a grid fine enough to resolve small polygons is intractable at
the scale of large ones, while a grid coarse enough to be tractable leaves small
polygons occupying only a handful of cells, collapsing their shape information into
